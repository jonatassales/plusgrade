...
## 🧱 Architecture Approaches & Design Patterns
...
- `pnpm build` → runs build across workspace packages/apps
- `pnpm format` → formats files with Biome
- `pnpm lint` → runs Biome checks
- `pnpm -r --if-present test` → runs tests in workspaces that define test scripts

---

## ✅ Plusgrade Validation Battery
